...
def relax(original: pyrosetta.Pose,
    ...
    """
    Relax a clone of a pose with constraints

    :param original: pose, NB. it returns the clone
    :param constraint_weight: integer only, default 5
    :param cycles: 3 is okay, 5 is good, 15 is overkill
    :param relax_to_start_coords:
    :return:
    """
